...
public class CalServiceServiceLocator extends org.apache.axis.client.Service implements com.king.webservices.CalServiceService {
    ...
    private java.lang.String CalService_address = "http://localhost:8077/01_JAX_RPC_Axis1Service/services/CalService";
    ...
    public com.king.webservices.CalService getCalService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.king.webservices.CalServiceSoapBindingStub _stub = new com.king.webservices.CalServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.king.webservices.CalService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.king.webservices.CalServiceSoapBindingStub _stub = new com.king.webservices.CalServiceSoapBindingStub(new java.net.URL(CalService_address), this);
                _stub.setPortName(getCalServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.king.com", "CalServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.king.com", "CalService"));
        }
